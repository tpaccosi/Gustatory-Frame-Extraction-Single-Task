...
# taste_word_tag = "Taste_Word"
# frameElements = ["Taste_Source","Quality"]
...
parser.add_argument("--tastewordtag", help="Taste word label", type=str, required=True)
...
with open(outPath, "w") as outfile:
	outfile.write("Book\t"+taste_word_tag+"\t"+"\t".join(frameElements)+"\tFull_Sentence")
	outfile.write("\n")
